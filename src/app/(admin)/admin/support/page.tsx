    ...
    <div className="p-4 sm:p-6 md:p-8 flex flex-col gap-6">
      ...
      <div className="bg-card rounded-xl shadow-sm border border-border/30 overflow-x-auto">
        ...
        {loading ? (
          ...
          <div key={t.ticket_id} className="grid grid-cols-[2fr_1fr_1fr_120px_120px] gap-4 px-5 py-3.5 items-center border-b border-border/10 last:border-0 hover:bg-muted/20 transition-colors min-w-[660px] md:min-w-0">
            <div>
